...
OBJECTS := main.o common.o matrix.o transform.o camera.o film.o geometry.o light.o spectrum.o sampling.o bsdf.o intersection.o entity.o scene.o integrator.o
